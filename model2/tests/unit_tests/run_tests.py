from model2.model.aurora_dataset import AuroraDataset, train_transform, eval_transform
from model2.model.cnn_model import AuroraCNN
from torch.utils.data import DataLoader

from model2.tests.unit_tests.dataset_test import test_train_dataset_single_sample, test_train_dataset_normalization_range, test_train_dataset_augmentation_variability
from model2.tests.unit_tests.model_test import test_model_forward, test_gap_removes_spatial_dims
from model2.tests.unit_tests.train_test import test_full_pipeline
